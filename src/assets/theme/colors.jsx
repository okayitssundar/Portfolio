...
const [theme, setTheme] = createSignal({
  primary: "#000814",
  secondary: "#ffc300",
  primaryButton: "#001d3d",
  secondaryButton: "#003566",
  accent: "#fffbe5",
});
...
const randomizeColor = () => {
  ...
  } while (randomColorSet === theme());
  setTheme({
    ...theme(),
    primary: randomColorSet.colors[1],
    secondary: randomColorSet.colors[2],
    primaryButton: randomColorSet.colors[3],
    secondaryButton: randomColorSet.colors[4],
    accent: randomColorSet.colors[0],
  });
};
export { randomizeColor, theme };
